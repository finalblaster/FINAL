  ...
  en: {
    ...
    login: {
      ...
      errors: {
        ...
        serverError: 'Service unavailable. Our team has been notified. Please try again later.',
        networkError: 'No connection. Please check your internet connection and try again later.',
        validationError: 'Please check your input and try again.',
        generalError: 'Unable to process your request. Please try again later.',
      },
  ...
  fr: {
    ...
    login: {
      ...
      errors: {
        ...
        serverError: 'Service indisponible. Notre équipe a été notifiée. Veuillez réessayer plus tard.',
        allFieldsRequired: 'Tous les champs sont obligatoires',
        networkError: 'Pas de connexion. Veuillez vérifier votre connexion internet et réessayer plus tard.',
        validationError: 'Veuillez vérifier vos informations et réessayer.',
        generalError: 'Impossible de traiter votre demande. Veuillez réessayer plus tard.',
      },
  ...
  es: {
    ...
    login: {
      ...
      errors: {
        ...
        serverError: 'Servicio no disponible. Nuestro equipo ha sido notificado. Por favor, inténtelo más tarde.',
        networkError: 'Sin conexión. Por favor, verifique su conexión a internet e inténtelo más tarde.',
        validationError: 'Por favor revisa tus datos e inténtalo de nuevo.',
        generalError: 'No se puede procesar su solicitud. Por favor, inténtelo más tarde.',
      },
  ...
  de: {
    ...
    login: {
      ...
      errors: {
        ...
        serverError: 'Dienst nicht verfügbar. Unser Team wurde benachrichtigt. Bitte versuchen Sie es später erneut.',
        networkError: 'Keine Verbindung. Bitte überprüfen Sie Ihre Internetverbindung und versuchen Sie es später erneut.',
        validationError: 'Bitte überprüfen Sie Ihre Eingaben und versuchen Sie es erneut.',
        generalError: 'Ihre Anfrage kann nicht verarbeitet werden. Bitte versuchen Sie es später erneut.',
      },
