...
const Logo = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 100" {...props} preserveAspectRatio="xMidYMid meet" id="svgAnimation">
      {/* Définir un dégradé radial très prononcé */}
      <defs>
        <radialGradient id="blueRadialGradient" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
          <stop offset="0%" stopColor="#a8c7ff" stopOpacity={0.9} />
